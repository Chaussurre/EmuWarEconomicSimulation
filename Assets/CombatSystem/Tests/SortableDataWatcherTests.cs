...
{
    public class SortableDataWatcherTests
    {
        [Test]
        public void NoDataTest()
        {
            var dataWatcher = new SortableDataWatcher<int>();
            int bufferData = 42;
        ...
        [Test]
        public void ModifierChangeBufferTest()
        {
            var dataWatcher = new SortableDataWatcher<int>();
            int bufferData = 42;
        ...
        [Test]
        public void SeveralModifiersChangeBufferTest()
        {
            var dataWatcher = new SortableDataWatcher<int>();
            int bufferData = 42;
